    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-xbox-dark via-background to-xbox-dark py-20 px-4">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 text-6xl text-primary rotate-12">
          ...
          <div className="absolute top-1/3 right-1/3 text-3xl text-primary/20 rotate-90">
            <Icon name="Monitor" size={45} />
          </div>
        </div>
        
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-transparent via-background/50 to-transparent"></div>
